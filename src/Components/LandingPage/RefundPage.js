    ...
    <>
      ...
      <div className="content container my-4">
        <p>
          ...
          , we strive to provide our users with a seamless and satisfactory
          experience. We understand that circumstances may change, and users may
          need to cancel their subscriptions or service requests. To ensure
          transparency and clarity, we have established the following
        ...
        <p>
          By subscribing to SmartGig Technology Private Limited, you acknowledge
