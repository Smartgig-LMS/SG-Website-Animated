...
const OurClients = () => {
    ...
    return (
        <>
            <div className='col-12 pt-5 vh-100 fixed'>
                <div className='container text-center'>
                    <img src='./Images/brand/OurClient.png' width="150" height="50" />
                    <h2 style={{ fontWeight: "700", marginTop: "20px" }}>Millions run on SmarGig every day</h2>
                ...
                <div className="container">
                    <div style={{ marginLeft: "55px", marginTop: "33px" }}>
                        <div className='d-flex py-3 px-2' style={{ gap: "30px" }}>
                        ...
                        <div className='d-flex col-12 py-3 px-2' style={{ gap: "30px" }}>
