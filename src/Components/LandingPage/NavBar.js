        ...
        <div className='Navsection'>
            <div className='d-flex' style={{ justifyContent: "space-between" }}>
                <div style={{ marginLeft: "30px" }} onClick={navigateFnLP}>
                    <img src='./Images/gobeyond/SG1Logo.svg' height="70px" width="131px" />
                </div>
                ...
                <div className='hamburgerMenu pr-3'>
                    <div id="outer-container">
                        <Menu id='navigation' right isOpen={isopen} customBurgerIcon={<img src='./Images/gobeyond/Subtract.svg'></img>}
                            customCrossIcon={<img src='./Images/gobeyond/close.svg' />}
                            onStateChange={(e) => handleStateChange(e)}
                        >
                            <li className='menu-item' onClick={navigateFnLP} id={`${activeState}`}>
                                Home
                            </li>
                            <li className="menu-item" onClick={navigateFn} id={`${activeState2}`}>
                                Partnerships
                            </li>
                            <li className="menu-item" onClick={navigateFn2} id={`${activeState3}`}>
                                Culture
                            </li>
                            <li className="menu-item" onClick={navigateFn3} id={`${activeState4}`} >
                                Careers
                            </li>
                            <li className="menu-item" onClick={navigateFn4} id={`${activeState5}`} >
                                Contact Us
                            </li>
                        </Menu>
                    </div>
