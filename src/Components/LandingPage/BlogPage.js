    ...
    <>
      ...
      <div className="BlogPageWeb">
        <div className="infiLogo">
          <img src="./Images/gobeyond/Gro83988394888.svg" />
        </div>
        <div className="d-flex col-12">
          <div className="p-5">
            <img
              src="./Images/gobeyond/FirstImg.png"
            ...
            <img
              src="./Images/gobeyond/3rd image (1) 2.svg"
              className="blogimg"
            />
            <p>
            ...
            <img
              src="./Images/gobeyond/Keychallenges22.svg"
              className="blogimg p-5"
            />
            <h5 style={{ fontFamily: "Roboto", fontStyle: "italic" }}>
          ...
          <div className="p-5">
            ...
            <div>
              <div className="card text-center mb-4">
                ...
                <img
                  src="./Images/gobeyond/About-1.jpg.svg"
                  className="blogimg2"
                />
                <h6
                  style={{
            ...
            >
              <h6 style={{ fontFamily: "lato" }}>NEWSLETTER</h6>
              <h6 style={{ fontFamily: "lato" }}>-----</h6>
              ...
              />
              <button
                style={{ backgroundColor: "#F38313", border: "none" }}
                className="p-3"
              >
                SUBSCRIBE
              </button>
            ...
            <div>
              <div className="card text-center mt-4">
                ...
                <ul style={{ textAlign: "start" }} className="p-5">
                  <li>Retail</li>
                  <hr />
                  <li>Manufacturing</li>
                  <hr />
            ...
            {/* <img
              src="./Images/gobeyond/Data Intеlligеncе Tools And Applications for Procеss Improvеmеnt 1.svg"
              className="blogimg p-5"
            /> */}
          </div>
        </div>
