      ...
      <div className="BlogPageWeb">
        ...
        >
          <div class="row">
            ...
            <div className="BlogCard col-lg-3 mt-4" onClick={topharma5}>
              <img src="./Images/gobeyond/Group 427322196.svg" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="BlogPageMobile">
        ...
        <div className="d-flex pl-2 pr-2" style={{ gap: "2%" }}>
          <div class="row">
            ...
            <div className="BlogCard col-6 mt-4" onClick={topharma5}>
              <img src="./Images/gobeyond/Group 427322196.svg" />
            </div>
          </div>
        </div>
