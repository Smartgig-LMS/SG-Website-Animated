          ...
          <div className="pl-5 pr-5 pt-2">
            <div className="d-flex justify-content-center align-items-center">
              <p>
                ...
                use LMS frequently. The age-old landscape of the Lab Management
                system has experienced a revolutionization in its scientific
                advancement with AI - Artificial Intelligence. It has played a
                pivotal role in transforming the way Lab management systems used
                to work previously.
                <br />
                <br />
              </p>
              <div className="pl-5 pr-5">
                <img src="./Images/gobeyond/VS (2) 1.svg" className="" />
              </div>
            </div>
      ...
      <div className="BlogPageMobile">
        ...
        <div className="col-12">
            <p>
              ...
              functionalities but serve different purposes. Lab management
              stepped in to fill the gap between ideas and implementation,
              hypothesis and tangible outcomes.
              <br />
              <br />
              ...
              revolutionization in its scientific advancement with AI -
              Artificial Intelligence. It has played a pivotal role in
              transforming the way Lab management systems used to work
              previously.
              <br />
              <br />
            </p>
